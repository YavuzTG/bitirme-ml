...
class ModelService:
    ...
    def __init__(
        ...
        self.model_bundle_path = model_bundle_path or os.path.join(base_dir, "trained_models.pkl")
        self.cnn_model_path = cnn_model_path or os.path.join(base_dir, "model_cnn.keras")
        self.lstm_model_path = lstm_model_path or os.path.join(base_dir, "model_lstm.keras")
        self._loaded = False
